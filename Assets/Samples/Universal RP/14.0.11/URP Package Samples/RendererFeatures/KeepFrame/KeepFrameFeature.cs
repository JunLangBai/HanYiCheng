...
public class KeepFrameFeature : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        m_CopyFrame.renderPassEvent =
            RenderPassEvent.AfterRenderingTransparents; //Frame color is copied late in the frame
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        RenderingUtils.ReAllocateIfNeeded(ref m_OldFrameHandle, descriptor, FilterMode.Bilinear, TextureWrapMode.Clamp,
            name: textureName);
    ...
    private class CopyFramePass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            var cmd = CommandBufferPool.Get("CopyFramePass");
    ...
    private class DrawOldFramePass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            {
                var cmd = CommandBufferPool.Get("DrawOldFramePass");
    ...
    {
        [Tooltip(
            "The material that is used when the old frame is redrawn at the start of the new frame (before opaques).")]
