...
namespace LeTai.Asset.TranslucentImage
{
    ...
    public class TranslucentImageSource : MonoBehaviour
    {
        ...
        /// </summary>
        private bool isFirstOnWillRenderCanvas;
#endif
        ...
        private Rect blurRegion = new(0, 0, 1, 1);
        ...
        private BackgroundFill backgroundFill = new();

        [SerializeField] [Tooltip("Always blur the entire blur region to reduce cpu usage")]
        private bool skipCulling;

        private int lastDownsample;
        private Rect lastBlurRegion = new(0, 0, 1, 1);
        private Rect lastCamPixelRect = new(0, 0, 1, 1);
...
#pragma warning restore CS0169
        ...
        private readonly List<IActiveRegionProvider> activeRegionProviders = new();
        ...
        private static readonly Rect FULLSCREEN_REGION = new(0, 0, 1, 1);

        private static ProfilerMarker profilerMarkerCull = new(nameof(TranslucentImageSource) + ".Culling");
        ...
        /// <summary>
        ///     Fill the background where the frame buffer alpha is 0. Useful for VR Underlay and Passthrough, where these areas
