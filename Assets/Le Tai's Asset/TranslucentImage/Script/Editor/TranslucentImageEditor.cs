...
namespace LeTai.Asset.TranslucentImage.Editor
{
    ...
    public class TranslucentImageEditor : ImageEditor
    {
        ...
        private bool needValidateMaterial;

        private bool needValidateSource;
        private SerializedProperty preserveAspect;

        private bool showMaterial = true;
        private AnimBool showTypeAnim;

        private EditorProperty source;
        private SerializedProperty sprite;
        private SerializedProperty spriteBlending;

        private List<TranslucentImage> tiList;
        ...
        private void DrawSpriteControls()
        {
            SpriteGUI();
            ...
            var type = (Image.Type)this.type.enumValueIndex;
        ...
        private void DrawSourceControls()
        {
            ...
            if (!source.serializedProperty.objectReferenceValue)
            {
                ...
                {
                    EditorGUILayout.HelpBox("No Translucent Image Source(s) found in current scene",
                        MessageType.Warning);
                }
            }
        }
        ...
        private void DrawMaterialControls()
        {
            using (var changes = new EditorGUI.ChangeCheckScope())
            {
                ...
                if (usingIncorrectShader)
                    EditorGUILayout.HelpBox("Material should use the \"UI/Translucent Image\" shader",
                        MessageType.Warning);
            ...
            using (var change = new EditorGUI.ChangeCheckScope())
            {
                ...
                using (_ = new EditorGUI.IndentLevelScope())
                {
                    ...
                    if (showMaterial)
                    {
                        ...
                        TranslucentImageShaderGUI.DrawProperties((MaterialEditor)materialEditor, materialProperties,
                            true);
                    }
