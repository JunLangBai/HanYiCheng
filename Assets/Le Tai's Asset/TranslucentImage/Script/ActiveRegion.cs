...
namespace LeTai.Asset.TranslucentImage
{
    ...
    {
        public static readonly ActiveRegion INACTIVE = new(Rect.zero,
            Matrix4x4.zero,
        ...
        /// <param name="vpMatrixCacheIndex">
        ///     Use VPMatrixCache.Index.INVALID For Screen Space - Overlay Canvas. Otherwise, see
        ///     <see cref="VPMatrixCache" />
        /// </param>
