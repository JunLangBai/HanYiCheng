...
namespace Febucci.UI.Core
{
    ...
    ///     Manual:
    ///     <see href="https://www.febucci.com/text-animator-unity/docs/writing-custom-tanimplayers-c-sharp/">
    ///         Writing Custom
    ///         TextAnimatorPlayers (C#)
    ///     </see>
    /// </remarks>
    ...
    public abstract class TAnimPlayerBase : MonoBehaviour
    {
            ...
            if (!textAnimator.allLettersShown)
            {
                ...
                while (!textAnimator.allLettersShown)
                {
                    ...
                    if (textAnimator.hasActions)
                        ...
                        while (textAnimator.TryGetAction(out var action))
                            //Default features
                            switch (action.actionID)
                            {
                                ...
                                case "speed":
                                    ...
                                    if (typewriterTagsSpeed <= 0) typewriterTagsSpeed = 0.001f;
                    ...
                    if (characterShown != ' ') onCharacterVisible?.Invoke(characterShown);
                    ...
                    if (HasSkipped())
                    {
                        ...
                        if (triggerEventsOnSkip) textAnimator.TriggerRemainingEvents();
                ...
                if (!canSkipTypewriter || !wantsToSkip) textAnimator.TriggerRemainingEvents();
        ...
        /// </summary>
        protected bool isBaseInsideRoutine { get; private set; }
        ...
        /// <param name="text"></param>
        /// <remarks>
        ///     If the typewriter is enabled but its start mode (editable in the Inspector) doesn't include
        ...
        public void ShowText(string text)
        {
            ...
            {
                if (startTypewriterMode.HasFlag(StartTypewriterMode.OnShowText)) StartShowingText();
            }
        }
        ...
        /// </summary>
        /// <param name="resetVisibleCharacters">
        ///     <code>false</code> if you want the typewriter to resume where it was left.
        ///     <code>true</code> if the typewriter should restart from character 0
        /// </param>
        public void StartShowingText(bool resetVisibleCharacters = false)
        {
            ...
            if (!isBaseInsideRoutine) //starts only if it is not already typing
        ...
        public void StartDisappearingText()
        {
            ...
            if (disappearanceOrientation == DisappearanceOrientation.Inverted && isBaseInsideRoutine)
            {
                Debug.LogWarning(
        ...
        private IEnumerator DisappearRoutine()
        {
            ...
            bool CanDisappear()
            {
                return isDisappearing && textAnimator.firstVisibleCharacter <= textAnimator.maxVisibleCharacters &&
                       textAnimator.maxVisibleCharacters > 0;
            }
            ...
            if (disappearanceOrientation == DisappearanceOrientation.SameAsTypewriter)
            {
                ...
                while (CanDisappear())
                {
                    ...
                    yield return WaitFor(
                        GetWaitDisappearanceTimeOf(charInfo[textAnimator.firstVisibleCharacter - 1].character));
                }
            }
            else
            {
        ...
        /// <summary>
        ///     Waits for user input in order to continue showing text. Invoked when there is a waitinput action tag (Manual:
        ///     <see href="http://localhost:4000/docs/performing-actions-while-typing/">Performing Actions while Typing</see>)
        /// </summary>
        /// <returns></returns>
        /// <remarks>
        ...
        [Obsolete(
            "'WaitTimeOf' is obsolete and will be removed from the next versions. Pleaase use 'GetWaitAppearanceTimeOf' instead.")]
        ...
        protected virtual IEnumerator DoCustomAction(TypewriterAction action)
        {
            throw new NotImplementedException(
                $"TextAnimator: Custom Action not implemented with type: {action.actionID}. If you did implement it, please do not call the base method from your overridden one.");
        }
