...
namespace Febucci.UI.Core
{
    ...
    ///     - Manual:
    ///     <see href="https://www.febucci.com/text-animator-unity/docs/creating-effects-in-the-inspector/#global-effects">
    ///         Creating
    ///         Global Effects
    ///     </see>
    /// </summary>
    ...
    public class TAnimGlobalDataScriptable : ScriptableObject
    {
        ...
        [SerializeField] internal PresetBehaviorValues[] globalBehaviorPresets = new PresetBehaviorValues[0];

        [SerializeField] internal PresetAppearanceValues[] globalAppearancePresets = new PresetAppearanceValues[0];

        [SerializeField] internal string[] customActions = new string[0];


        [SerializeField] internal bool customTagsFormatting;
