...
#pragma warning restore 0649
        ...
        {
            for (byte i = 0; i < sources.vertices.Length; i++) data.vertices[i] = sources.vertices[i];
        }

        public void ResetColors()
        {
            for (byte i = 0; i < sources.colors.Length; i++) data.colors[i] = sources.colors[i];
        }

        public void Hide()
        {
            for (byte i = 0; i < sources.vertices.Length; i++) data.vertices[i] = Vector3.zero;
        }
    }
    ...
    public struct CharacterData
    {
        ...
        ///     P.S. If you want to modify vertices/colors, please use the <see cref="vertices" /> and <see cref="colors" /> arrays
        ///     variables instead.
        /// </summary>
